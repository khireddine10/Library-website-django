...
urlpatterns = [
	...
	path('memoire/', views.MemoireListView, name='memoires'),
	path('memoire/<int:pk>', views.MemoireDetailView, name='memoire-detail'),
	path('memoire/create/', views.MemoireCreate, name='memoire_create'),
